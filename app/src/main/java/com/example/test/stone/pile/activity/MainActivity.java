package com.example.test.stone.pile.activity;
...
import com.example.test.stone.pile.entity.ItemEntity;
import com.example.test.stone.pile.libs.PileLayout;
import com.example.test.stone.pile.util.Utils;
import com.example.test.stone.pile.widget.FadeTransitionImageView;
import com.example.test.stone.pile.widget.HorizontalTransitionLayout;
import com.example.test.stone.pile.widget.VerticalTransitionLayout;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_ston);
