...
public class ScrollListenerHorizontalScrollView extends HorizontalScrollView{
    ...
    public interface ScrollViewListener {
        ...
        void onScrollChanged2(ScrollListenerHorizontalScrollView scrollListenerHorizontalScrollView, int x, int y, int oldx, int oldy);
    ...
    protected void onScrollChanged(int x, int y, int oldx, int oldy) {
        ...
        if (scrollViewListener != null) {
            scrollViewListener.onScrollChanged2(this, x, y, oldx, oldy);
        }
    }
